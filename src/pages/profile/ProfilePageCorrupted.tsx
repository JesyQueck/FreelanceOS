...
import { getUserProfile, createOrUpdateUserProfile, UserProfile, PortfolioItem, getPortfolioItems, createPortfolioItem, deletePortfolioItem, generateShareLink, ensureUserHasSlug, getFreelancerProfile } from "../../utils/supabase";
