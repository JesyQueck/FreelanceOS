    ...
    <div className="space-y-6">
      ...
      {loading ? (
        <div className="text-center py-12">
          ...
          <p className="text-[#A0A0A0]">Loading services...</p>
        </div>
      ) : (
            ...
            <div key={service.id} className="bg-[#0A0A0A] rounded-2xl p-6 border border-[#1A1A1A] shadow-sm hover:shadow-md transition-all flex flex-col h-full">
                ...
                <div className="flex items-center gap-1">
                  <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                    service.status === 'active' 
                      ...
                      : 'bg-[#1A1A1A]/10 text-[#A0A0A0] border border-[#1A1A1A]/20'
                  }`}>
              ...
              <div className="flex items-center gap-2 pt-4 border-t border-[#1A1A1A]/60 mt-auto">
                ...
                <button 
                  ...
                  disabled={isSaving}
                  className="flex items-center justify-center p-2 text-[#A0A0A0] hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
